...
<section class="read-post">
   ...
   <?php
      $select_posts = $conn->prepare("SELECT * FROM `posts` WHERE post_id = ? AND created_by = ?");
   ...
   <form method="post">
      ...
      <div class="status" style="background-color:<?php if($fetch_posts['status'] == 'published'){echo 'limegreen'; }else{echo 'coral';}; ?>;"><?= $fetch_posts['status']; ?></div>
